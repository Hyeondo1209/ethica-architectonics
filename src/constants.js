...
export const HALL_ENTRY   = 'asc-sphere'
export const ORB_GLASS    = false                    // ★㊵-5c 유리 캐노피 스위치(현도: 렉 — 잠깐 잠금). true = 동캡 유리+테 복귀(코드 보존)
...
export const ORB_GLASS_F  = 0.28                     // ★컷 위치(노브, 0~1) — 작을수록 캐노피가 넓어짐. 0.28 → 캡 반각 ≈73.7°
export const ORB_GLASS_X  = ORB_CX + ORB_R * ORB_GLASS_F    // 컷 평면 x — 아치 보이드 동단과 무간섭(검증 강제)
export const ORB_RING_R   = Math.sqrt(ORB_R * ORB_R - (ORB_R * ORB_GLASS_F) ** 2)  // 테 고리 반경 ≈13.44
