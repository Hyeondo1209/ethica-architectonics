...
export const RAD_ANG0    = Math.PI / 4        // 첫 꽃잎 각(45° NE). 4방 = +90°씩. 나선 도착 슬롯(8~67°)과의 관계는 튜닝 노브
export const RAD_R       = 62                 // 꽃잎 중심 반경 = 고리 중심선 반경(돔 사면 위 부양. 표면고 35.9 대 바닥 49.3)
export const RAD_PRX     = 13                 // 꽃잎 타원구 수평 반축(평면 반지름)
export const RAD_PRY     = 8.5                // 꽃잎 타원구 수직 반축(납작 = 유선형 렌즈)
export const RAD_PCY     = 50                 // 꽃잎 중심 높이(셸 41.5~58.5 · 바닥판 49.3 · 돔과 최소 간극 3.8 검증)
...
export const RAD_ARC_IN  = 9 * Math.PI / 180  // 고리 끝이 꽃잎 각 안쪽으로 파고드는 각(셸 접선 반각 ≈11.8° 안 = 봉합)
