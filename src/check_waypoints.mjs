...
console.log('\n— W. 보행 (FREE_WALK를 끄면 걸어서 완주할 수 있는가) —')
{
  ...
  console.log('  · W4. walkable 태그 선언 대장 (JSX 정적 대조)')
  {
    ...
    const LEDGER = [
      ...
      ['Room.jsx',          29, 12, 0, 9],   // ★114(08.05) +1 = 벽 밑동 팔각 각뿔대(false — 밟는 면 아님) · ★111(08.04) +1 = 공리 볼트(문) 7기(false — 아치 안 밟는 면은 코일이 담당) · ★107(08.03) +3 = 나선 매스(walkable) + ②기둥·①보(false) · ★101(08.02) +5 = 판 고리·각뿔대 입술·바닥 슬래브·기단 고리 분기 + 빗면(false) · ★102 +3 = 감실 바닥·ⓑ계단(walkable) + 감실 천장/옆/뒤(false) · ★103 +2 = 슬롯 바닥(walkable) + 슬롯 옆·뒷벽(false) · ★104 +1 = 꺾인 상승 계단(walkable)
      ['Steles.jsx',         5,  0, 0, 0],
    ]
