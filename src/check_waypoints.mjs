...
console.log('\n— W. 보행 (FREE_WALK를 끄면 걸어서 완주할 수 있는가) —')
{
  ...
  console.log('  · W4. walkable 태그 선언 대장 (JSX 정적 대조)')
  {
    ...
    const LEDGER = [
      ...
      ['Dome.jsx',          77, 21, 4, 6],   // ★★★225(09.24) +1 = 등불 빛기둥(LampBeam — 무선언 · 회랑 9기·등불 방이 같은 컴포넌트) 76→77 · ★★★224(09.20) +1 = 등불 리브 9기 instancedMesh(LampRibs — 무선언 · 갓 입 발광면 <mesh는 조건부 게이트로 리터럴 존치) 75→76 · ★★★223(09.18) +1 = 회랑 **시작 끝캡**(φ0 · 벽·무선언) 74→75 · ★221-b(09.18) ±0 = 등불 방 뿌리 목은 <LampRoot/> 재사용(대장은 <mesh 리터럴 수) · ★★★221(09.14) +1 = 등불 뿌리 목(LampRoot — 무선언) 73→74 · ★★★220(09.13) +1 = 회랑 입 아치 패널(CloisterMouthWall — 벽·무선언). 72→73   // ★87 +1 = MirrorPads · ★90 +1 = 리드 연결 계단 · ★93 +1 = 하판 고리판(전부 walkable)
