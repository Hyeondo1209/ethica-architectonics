...
console.log('\n— W. 보행 (FREE_WALK를 끄면 걸어서 완주할 수 있는가) —')
{
  ...
  console.log('  · W4. walkable 태그 선언 대장 (JSX 정적 대조)')
  {
    ...
    const LEDGER = [
      ['Corridor.jsx',      39, 17, 0, 6],   // ★★★214(09.06) +1 = 갓 치마 커튼 가닥 메시 · ★214-l +1 후광 통(둘 다 walkable false — 빛). 37→39 · false 4→6   // ★★★147-g(08.19) +1 = 갓 서쪽 처마 살(밟는 면 아님 — walkable 태그 없음. 36→37) · ★94-c 중앙 기둥 · ★95 반십각 기둥 · ★96 헌치 · ★98 서쪽 빗면(전부 walkable:false)
