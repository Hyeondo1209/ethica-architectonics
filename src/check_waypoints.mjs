  ...
  console.log('  · W4. walkable 태그 선언 대장 (JSX 정적 대조)')
  {
    ...
    const LEDGER = [
      ...
      //  구 Tunnel 3메시도 보존계로 남아 함께 세어진다. 체제를 바꿔도 이 수는 불변.
                        ['Radial.jsx',        28, 11, 0, 8],   // ★130(08.14) +2 = 접속 통로 밀봉 관·나선(walkable) + 미니 첨탑(false) · ★91/119/121/122 계열 · ★122-Q 문지방 · ★122-R 어귀 판(walkable:true) · ★123 +1 = 적도 칼라(false) · ★126(08.13) +1 = 1p3 지지 팔(false — 밟는 면 아님. 센서스는 소스 기준 — k 게이트 무관)
