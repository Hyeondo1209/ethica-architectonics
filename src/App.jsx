...
const ROOM_LAND_R      = 6                                     // 착지 디스크 = 실린더 반지름 = 박스 반폭(지름 12 = 박스 가로폭). 크기감 맞춤
const ROOM_CYL_TOP     = 90                                    // 빛 우물 실린더 꼭대기 높이(다리 49 위로 솟음). 튜닝 노브
  ...
  return (
    <group position={[ROOM_CX, 0, 0]}>
      ...
      <mesh position={[0, (ROOM_CEIL_Y - 3 + ROOM_CYL_TOP) / 2, 0]}>
        <cylinderGeometry args={[ROOM_LAND_R, ROOM_LAND_R, ROOM_CYL_TOP - (ROOM_CEIL_Y - 3), 40, 1, true]} />
